...
void Single_Race::setSingle_RaceState(RenderWindow &window, Error &error) {
...
int Single_Race::getSingle_RaceLap(double posx, double posy, RenderWindow &window, Error &error) {
...
int Single_Race::getSingle_RaceWeather(double posx, double posy, RenderWindow &window, Error &error) {
...
void Single_Race::setSingle_RaceState2(RenderWindow &window, Error &error) {
...
int Single_Race::getSingle_RaceCircuit(double posx, double posy, RenderWindow &window, Error &error) {
...
void Single_Race::End_SingleRace(RenderWindow &window, Error &error) {
