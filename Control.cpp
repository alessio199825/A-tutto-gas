...
bool Control::SetControl(int num_circuit, float y_CarPlayer, float x_CarPlayer) {
...
bool Control::CircuitOne_control(float y_CarPlayer, float x_CarPlayer) {


    if(x_CarPlayer<=368 && x_CarPlayer>=0 && y_CarPlayer<=145 && y_CarPlayer>=0){
    ...
    if(x_CarPlayer>368 && x_CarPlayer<=1000 && y_CarPlayer<=113 && y_CarPlayer>0){
    ...
    if(x_CarPlayer>=505 && x_CarPlayer<=1000 && y_CarPlayer<=159 && y_CarPlayer>113){
    ...
    if(x_CarPlayer>=825 && x_CarPlayer<=1000 && y_CarPlayer>159 && y_CarPlayer<=371){
    ...
    if(x_CarPlayer>=686 && x_CarPlayer<=1000 && y_CarPlayer>=350 && y_CarPlayer<=600){
    ...
    if(x_CarPlayer>=435 && x_CarPlayer<686 && y_CarPlayer>=349 && y_CarPlayer<=600){
    ...
    if(x_CarPlayer>=324 && x_CarPlayer<=686 && y_CarPlayer>=464 && y_CarPlayer<=600){
    ...
    if(x_CarPlayer>=140 && x_CarPlayer<=230 && y_CarPlayer>=522 && y_CarPlayer<=600){
    ...
    if(x_CarPlayer>=0 && x_CarPlayer<=145 && y_CarPlayer<=522 && y_CarPlayer>145){
        if(x_CarPlayer<145)
            return true;
    }

    if(x_CarPlayer>=238 && x_CarPlayer<238 && y_CarPlayer>=151 && y_CarPlayer<=493){
...
bool Control::CircuitTwo_control(float y_CarPlayer, float x_CarPlayer) {

    return false;
}

bool Control::CircuitThree_control(float y_CarPlayer, float x_CarPlayer) {
